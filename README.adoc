...
this is a development branch, is not officially released by CompuLab.
...
[source,console]
git clone -b devel-thud https://github.com/compulab-yokneam/meta-bsp-imx8mq.git sources/meta-bsp-imx8mq/
